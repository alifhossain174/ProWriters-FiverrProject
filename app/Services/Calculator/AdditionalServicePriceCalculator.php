...
class AdditionalServicePriceCalculator
{
    ...
    public function get()
    {
        ...
        if ($this->data->added_additional_services && is_array($this->data->added_additional_services)) {
            ...
            foreach ($additionalServices as $additionalService) {
                $price = $this->getPrice($additionalService->type, $additionalServiceQuantity[$additionalService->id], $additionalService->price, $this->data->quantity, $this->data->basicPrice);
                $data['amount'] += $price;
                $data['added_services'][] = [
    ...
    public function getPrice($additionalServiceType, $additionalServiceQuantity, $price, $orderQuantity, $basicPrice)
    {
