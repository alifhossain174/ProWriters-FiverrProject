...
class DashboardController extends Controller
{
    ...
    private function superAdminDashboard()
    {
        ...
        //         'causer_url'  => get_user_profile_link($activity->causer),
        //         'description' => $activity->description,
        //         'subject'     => $activity->subject->number,
        //         'subject_url' => $activity->getExtraProperty('url'),
    ...
    {
        $total = $this->getProfit(Carbon::now()->subDays(30)->toDateString(), Carbon::today()->toDateString());
