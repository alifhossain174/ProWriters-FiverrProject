...
class InvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        return inertia('Admin/Invoices/Index', [
            ...
            //     'title' => __('Invoices'),
            //     'urls'  => [
            //         'new_item' => route('admin.invoices.create'),
            //         'search'   => route('admin.invoices.index'),
            //     ],
            // ],
            'data'    => function () {
                ...
                return [
                    'title'            => __('Invoices'),
                    'ribbon_bg_colors' => InvoiceStatusType::colors(),
                    'dropdowns'        => [
    ...
    public function prepareInvoiceItem($item)
    {
        ...
        if (isset($item['linked_task_id']) && $item['linked_task_id']) {
            $invoiceable_type  = class_basename(Task::class);
    ...
    public function show(Invoice $invoice)
    {
        ...
        return inertia('Admin/Invoices/Show', [
            ...
            'data'    => [
                ...
                'ribbon_bg_color' => InvoiceStatusType::getColorByStatus($invoice->invoice_status_id),
                'allow'           => [
                    'editing'           => true,
    ...
    public function storeAdjustPaymentAdjustFromWallet(Request $request, Invoice $invoice, InvoiceService $invoiceService)
    {
        ...
        $request->validate([
            'amount' => ['required', new MoneyFormat, 'lte:' . $balance_due],
        ]);
