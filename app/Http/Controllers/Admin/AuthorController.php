...
class AuthorController extends Controller
{
    ...
    public function index(Request $request)
    {
        return inertia('Admin/Authors/Index', [
            ...
            'authors' => User::authors(true)
                ->select(['uuid', 'code', 'first_name', 'last_name', 'email', 'phone', 'photo', 'last_login_at', 'inactive', 'author_levels.name AS author_level_name', 'education_levels.name AS education_level_name'])
    ...
    // {
    //     $data = User::authors()->select(['id', 'first_name', 'last_name', 'email'])
