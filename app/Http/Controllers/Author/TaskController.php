...
class TaskController extends Controller
{
    ...
    public function calendar()
    {
        return inertia('Author/Calendar', [
            'data' => [
                'events' => Task::select(['uuid', 'number as title', 'title as description', 'dead_line_for_author as start'])->whereNotNull('dead_line_for_author')->where('author_id', auth()->user()->id)
