...
class CreateDummyData extends Command
{
    ...
    public function handle()
    {
        ...
        File::cleanDirectory(Storage::path('public/attachments/'));
    ...
    private function dummySettings()
    {
        $records = [
            ...
            ['option_key' => 'tinymce_key', 'option_value' => '30pbmddzz9fs13mm4afrxvkub26sdcmse0te7i0zopzuaeaz', 'auto_load_disabled' => false],
        ];
        ...
        PaymentGateway::insert([
            ...
            [
                ...
                'keys'        => json_encode([
                    ...
                    'client_id'     => "AZyzyBPD5pLBCpmSvH7piN4o3P9dZ8_ehrN19ZEi0f0N4lJPuSt1BvwxM-LvF7BRQEpkTL0CUwORHyod",
                    'client_secret' => "EGgRkyE7TxNCjMfMgiZakmfje8hHknL4XMmb-6O0mM9MnWIOvCvTiJyM0pjv08NFAQw_jILdGgjR1eP_",
                    'environment'   => 'sandbox',
                ]),
            ...
            [
                ...
                'keys'        => json_encode([
                    ...
                    'private_key'       => '59f9e4bf4b149f54fa553fb9c7f7c137',
            ...
            [
                ...
                'name'        => 'Stripe',
                'keys'        => json_encode([
                    'publishable_key' => 'pk_test_JBnqGXZs3HVpaR4bBwPFXoTm',
