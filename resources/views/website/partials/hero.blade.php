    ...
    <div class="min-vh-100" id="hero">
        <div class="container pb-5">
            @if($image_position == 'center')
                <div class="row">
                    <div class="col-md-12 text-center">
                        <img src="{{ asset(settings('website_hero_image')) }}" alt="{{ $hero->image_alt_text }}" class="img-fluid w-50" />
            ...
            @elseif($image_position == 'left')
                <div class="row">
                    <div class="col-md-5">
                        <img src="{{ asset(settings('website_hero_image')) }}" alt="{{ $hero->image_alt_text }}" class="img-fluid" />
                    </div>
                    <div class="col-md-7">
