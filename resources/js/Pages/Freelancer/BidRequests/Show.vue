  ...
  <div class="container page-container mt-3">
    <div class="row mt-4 mb-4">
      ...
      <div class="col-md-6 text-md-end">
        <Link
          :href="route('freelancer.bidRequests.index')"
        ...
        <Link
          ...
          :href="route('freelancer.bidRequests.bids.create', bid_request.uuid)"
    ...
    withdrawBid() {
      ...
      this.confirmDialog(this.__("Yes, Withdraw my bid"), function () {
        scope.$inertia.delete(
          route("freelancer.bids.destroy", scope.data.bid.uuid),
          {
            preserveState: false,
          }
        );
