<template>
  ...
  <div class="container page-container">
    <PageTitle :title="data.title">
      <div class="float-end">
        <Link class="btn btn-sm btn-light" :href="route('freelancer.paymentRequests.index')">
    ...
    <div class="row">
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td class="description text-left">
                        ...
                        (
                        <Link
                          :href="route('freelancer.tasks.show', item.task.uuid)"
      ...
      <div class="col-md-3">
        <Link
          ...
          :href="route('freelancer.paymentRequests.archive', paymentRequest.uuid)"
          method="post"
          as="button"
          type="button"
          preserve-scroll
        ...
        <Link
          ...
          :href="route('freelancer.paymentRequests.unarchive', paymentRequest.uuid)"
          method="post"
          as="button"
          type="button"
          preserve-scroll
