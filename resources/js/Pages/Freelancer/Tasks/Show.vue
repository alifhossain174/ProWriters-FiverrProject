<template>
  <TaskShowLayout :task="task" activeTab="general">
    ...
    <div class="d-flex flex-row-reverse bd-highlight">
      <Link class="btn btn-sm btn-light" :href="route('freelancer.tasks.index')">
      ...
      <Link
        ...
        :href="route('freelancer.tasks.archive', task.uuid)"
        method="post"
        as="button"
        type="button"
        preserve-scroll
      ...
      <Link
        ...
        :href="route('freelancer.tasks.unarchive', task.uuid)"
        method="post"
        as="button"
        type="button"
        preserve-scroll
      ...
      <Link
        ...
        :href="route('freelancer.tasks.start_working', task.uuid)"
        method="post"
        as="button"
        type="button"
      >
...
export default {
  ...
  computed: {
    isStartWorkingButtonEnabled() {
      return this.data.statuses_allows_start_working.includes(this.task.task_status_id);
    },
