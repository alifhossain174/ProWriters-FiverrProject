      ...
      <div class="row mt-3">
        <div class="col-lg-12">
          <div class="text-end text-white" v-if="showCountDown(task)">
            <Countdown :until="task.dead_line_for_freelancer" />
          </div>
            ...
            <ul class="nav nav-tabs task-navigation" id="myTab" role="tablist">
              <li class="nav-item">
                <Link
                  ...
                  :href="route('freelancer.tasks.show', task.uuid)"
                  aria-selected="true"
                  >{{ __("General") }}</Link
                >
              </li>
              <li class="nav-item">
                <Link
                  ...
                  :href="route('freelancer.tasks.attachments.index', task.uuid)"
                  >{{ __("Attachments") }}</Link
                >
              </li>
              <li class="nav-item">
                <Link
                  ...
                  :href="route('freelancer.tasks.discussions.index', task.uuid)"
                  >{{ __("Discussions") }}</Link
                >
              </li>
              <li class="nav-item">
                <Link
                  ...
                  :href="
                    route(
                      'freelancer.tasks.internal-discussions.index',
                      task.uuid
                    )
                  "
              ...
              <li class="nav-item">
                <Link
                  ...
                  :href="route('freelancer.tasks.content', task.uuid)"
              ...
              <li class="nav-item">
                <Link
                  ...
                  :href="route('freelancer.tasks.works.index', task.uuid)"
