      ...
      <div class="col-md-6">
        <fieldset class="border rounded-3 p-3">
          ...
          <small class="text-muted">{{
            data.page.additional_data.form_sub_title
          }}</small>
          <div class="mb-4"></div>
          <form
            @submit.prevent="
              form.post(
                route('public.author.application.store'),
                formConfig
              )
            "
          >
...
export default {
  ...
  computed: {
    displaySubjects() {
      return (
        this.form.service_id_1 &&
        this.form.service_id_1 != this.data.service_types.resume_writing
      );
    },
  },
  data() {
