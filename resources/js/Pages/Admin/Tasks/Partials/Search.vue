<template>
  <div class="fs-8" id="search-form">
    ...
    <Select
      ...
      :searchable="true"
      :label="__('Customer Service Level')"
      name="service_level_id"
      :options="data.dropdowns.service_levels"
      bottom_margin="mb-1"
    />
...
export default {
  ...
  created() {
    if (this.filters?.search) {
      ...
      if (search?.service_level_id) {
        this.form.service_level_id = parseInt(search.service_level_id);
      }
