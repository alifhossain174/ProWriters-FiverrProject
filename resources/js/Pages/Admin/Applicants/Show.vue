    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form
              @submit.prevent="enrollForm.post(route('admin.applicants.enroll', applicant.uuid))"
            >
              <Select
              ...
              <SubmitButton :button_text="__('Enroll as Author')" :disabled="enrollForm.processing" />

              <small>{{ __('Please note that applicant record will be removed after enrollment') }}</small>
            </form>
          </div>
        </div>
