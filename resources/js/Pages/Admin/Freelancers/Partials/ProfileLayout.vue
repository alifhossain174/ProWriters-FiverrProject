        ...
        <div class="col-lg-9">
          <div class="d-flex justify-content-between mb-4 mt-4">
            ...
            <div>
              ...
              <span v-if="freelancer.inactive" class="badge bg-danger">{{
                __("Inactive")
              }}</span>
            </div>
          </div>
          ...
          <div class="d-flex">
            <div class="btn-group flex-wrap" role="group">
              ...
              <Link
                :href="route('admin.freelancers.edit', freelancer.uuid)"
                class="btn btn-light"
              >
              ...
              <DialogLink
                :href="route('admin.freelancers.password', freelancer.uuid)"
                class="btn btn-light"
              >
              ...
              <div class="btn-group ml-auto" role="group">
                ...
                <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                  <li>
                    <DialogLink
                      class="dropdown-item"
                      :href="route('admin.freelancers.tasks', freelancer.uuid)"
                      >{{ __("Tasks") }}</DialogLink
                    >
                  </li>
                  <li>
                    <DialogLink
                      class="dropdown-item"
                      :href="route('admin.freelancers.bills', freelancer.uuid)"
                      >{{ __("Bills") }}</DialogLink
                    >
                  </li>
                </ul>
            ...
            <div class="card border-0">
              <div class="card-profile-cover">
                <img
                  ...
                  class="card-img-top freelancer-avatar"
                />
              </div>
              <div class="mx-auto">
                <img
              ...
              <div class="card-body p-3 pt-0 text-center">
                <h5 class="mb-0">{{ freelancer.full_name }}</h5>

                <div class="mt-4">
                  <DialogLink
                    :href="route('admin.freelancers.avatar', freelancer.uuid)"
                    class="btn btn-link"
                  >
  ...
  methods: {
    destroy() {
      this.deleteConfirmDialog(
        this,
        route("admin.freelancers.destroy", this.freelancer.uuid)
      );
    },
  },
};
