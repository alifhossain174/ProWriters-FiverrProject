<template>
  ...
  <div class="container page-container">
    ...
    <form
      @submit.prevent="form.post(route('admin.invoices.store'), formConfig)"
    >
      <div class="row">
        <div class="col-md-6">
          <SearchCustomer
            ...
            <tbody>
              <tr v-for="(item, index) in form.invoice_items" :key="index">
                ...
                <td>
                  ...
                  />
                  <ValidationError
                    :name="getErrorFieldName('description', index)"
                  />
                </td>
                <td>
                  <input
                    ...
                    @keypress="
                      onlyNumber($event, form.invoice_items[index].quantity)
                    "
                  />
                  <ValidationError
                ...
                <td>
                  <input
                    ...
                    @keypress="
                      onlyNumber($event, form.invoice_items[index].price)
                    "
                  />
                ...
                <td class="text-end">
                  ...
                  <ValidationError
                    :name="getErrorFieldName('sub_total', index)"
                  />
                </td>
                <td class="text-end">
                  <button
