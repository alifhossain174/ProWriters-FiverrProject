    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="card card-bg-red-light">
          <div class="card-body">
            <h5 class="card-title">{{ __('Bill Paid') }}</h5>
            <h5 class="float-end">
              <i
                class="fas fa-spinner fa-spin"
                v-if="!statistics.paid_bills_amount"
              ></i>
              <span v-else v-text="statistics.paid_bills_amount.value"></span>
            </h5>
            <p>{{ __("Last 30 days") }}</p>
          </div>
        </div>
        ...
        <div class="card card-bg-green">
          <div class="card-body">
            ...
            <h5 class="float-end">
              <i
                class="fas fa-spinner fa-spin"
                v-if="!statistics.profit_amount"
              ></i>
              <span v-else v-text="statistics.profit_amount.value"></span>
            </h5>
            <p>{{ __("Last 30 days") }}</p>
          </div>
        </div>
      ...
      <div class="dashboard-stat hoki">
        ...
        <div class="details">
          <div class="number">
            <i
                class="fas fa-spinner fa-spin"
                v-if="!statistics.uninvoiced_tasks"
              ></i>
...
export default {
  ...
  created() {
    ...
    this.getStatistics("paid_bills_amount");
  ...
  methods: {
    ...
    loadIncomeGraph() {
      ...
      axios
        .post(route("admin.dashboard.graph.income"))
        .then(function (response) {
