    ...
    <div class="document-container">
      ...
      <div class="ribbon-overlay">
        <span
          ...
          :style="{ background: data.ribbon_bg_color }"
        >
          {{ invoice.status.name }}
        </span>
      </div>
            ...
            <tbody>
              <tr v-for="(item, index) in invoice.items" :key="index">
                ...
                <td class="description">
                  <strong>{{ item.name }}</strong> <span v-if="item.invoiceable"> ({{ data.invoiceable_types[item.invoiceable_type] }} {{ item.invoiceable.number }}) </span>
                  <br />    
          ...
          <table class="table table-sm text-end">
            <tbody>
              ...
              <tr class="fw-bold">
                ...
                <td class="subtotal">{{ formatMoney(invoice.total - invoice.amount_paid) }}</td>
              </tr>
            </tbody>
          </table>
        </div>
