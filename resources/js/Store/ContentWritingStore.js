...
export class ContentWritingStore {
    getFieldValues(state, orderStoreHelper) {
        ...
        state.form.language_id = orderStoreHelper.language();
        state.form.grammatical_person_id = orderStoreHelper.grammaticalPerson();

        state.form.title = null;
        state.form.content_goals = null;
        state.form.target_audience = null;
        state.form.target_keywords = null;
        state.form.links_to_example_content = null;
        state.form.style_and_tone = null;

        state.form.structure_and_formatting_requirements = null;
        state.form.referencing_and_linking_preferences = null;
        state.form.things_to_avoid = null;
        state.form.additional_notes = null;
    }
