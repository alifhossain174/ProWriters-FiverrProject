...
class CreateFreelancerLevelsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('freelancer_levels', function (Blueprint $table) {
            ...
            $table->decimal('freelancer_price_per_word_writing', config('database.decimal.total'), config('database.decimal.places'))->default(0)->nullable();
            ...
            $table->decimal('freelancer_price_per_word_editing', config('database.decimal.total'), config('database.decimal.places'))->default(0)->nullable();
            ...
            $table->decimal('freelancer_price_per_word_proofreading', config('database.decimal.total'), config('database.decimal.places'))->default(0)->nullable();
