...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tasks', function (Blueprint $table) {
            ...
            $table->unsignedInteger('service_level_id')->nullable();
            $table->foreign('service_level_id')
                ->references('id')
                ->on('service_levels');
            ...
            $table->decimal('basic_price', config('database.decimal.total'), config('database.decimal.places'));
            $table->decimal('service_level_price', config('database.decimal.total'), config('database.decimal.places'));
