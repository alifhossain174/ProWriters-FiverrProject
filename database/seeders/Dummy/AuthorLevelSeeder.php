    ...
    public function run()
    {
        AuthorLevel::insert([
            [
                ...
                'author_price_per_word_writing'      => 0.005,
                'customer_price_per_word_editing'        => 0.006,
                'author_price_per_word_editing'      => 0.005,
                'customer_price_per_word_proofreading'   => 0.005,
                'author_price_per_word_proofreading' => 0.003,
            ...
            [
                ...
                'author_price_per_word_writing'      => 0.006,
                'customer_price_per_word_editing'        => 0.007,
                'author_price_per_word_editing'      => 0.006,
                'customer_price_per_word_proofreading'   => 0.006,
                'author_price_per_word_proofreading' => 0.005,
