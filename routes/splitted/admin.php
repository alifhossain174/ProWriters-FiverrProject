...
use App\Http\Controllers\Admin\Business\ServiceLevelController;
...
use App\Http\Controllers\Admin\SubmittedWorkController;
...
Route::get('tasks/{task}/works', [SubmittedWorkController::class, 'index'])->name('tasks.works.index');

Route::get('tasks/{task}/content', [SubmittedWorkController::class, 'content'])->name('tasks.content');
Route::post('tasks/{task}/content/comment', [SubmittedWorkController::class, 'storeContentComment'])->name('tasks.content.comment');
